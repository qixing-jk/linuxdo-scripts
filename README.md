...
> [!important]
> **维护状态说明**：由于个人精力有限，本项目已停止主动维护，不再处理新的功能需求与反馈（历史 Issues 已迁移至 Discussions）。
>
> 如果您对本项目感兴趣，欢迎：
> - 直接提交 Pull Request，经审核确认无误后会尽快合并；
> - Fork 本仓库继续开发与维护。本项目基于 [Apache License 2.0](LICENSE) 开源，Fork 后请继续遵循该协议。
